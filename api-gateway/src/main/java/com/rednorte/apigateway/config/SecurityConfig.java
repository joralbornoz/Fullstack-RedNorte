...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
                // 👇 AGREGA ESTA LÍNEA AQUÍ PARA APAGAR EL POPUP DEL NAVEGADOR
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/api/v1/lista-espera/paciente/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_MEDICO", "ROLE_PACIENTE")
                        .pathMatchers("/api/v1/bff/paciente/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_MEDICO", "ROLE_PACIENTE")
