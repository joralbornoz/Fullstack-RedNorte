...
public class UsuarioController {
    ...
    public ResponseEntity<Boolean> verificarExistencia(@PathVariable String rut) {
        try {
            // ✅ CORREGIDO: Usamos obtenerUsuarioPorRut y comparamos contra null
            var usuario = gestionarUsuarioUseCase.obtenerUsuarioPorRut(rut);
            return ResponseEntity.ok(usuario != null);
        } catch (Exception e) {
            // Si lanza excepción (por ejemplo, "Usuario no encontrado"), devolvemos false
