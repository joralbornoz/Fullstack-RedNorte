...
// ✅ IMPORTACIÓN CORREGIDA: Asegúrate que la ruta sea la correcta en tu proyecto
...
export default function AdminUsuariosDashboard() {
    ...
    const cargarUsuarios = async () => {
        try {
            setLoading(true);
            // ✅ CORREGIDO: Usamos listarTodos() que es el método real en tu usuarioService
            const response = await usuarioService.listarTodos();
            
            // 🔍 DEBUG: Si no ves datos, abre la consola del navegador (F12) y verás qué llega
